...
static void view2_prev_btn_clicked_cb(void *data, Evas_Object *obj, void *event_info)
{
	appdata_s *ad = (appdata_s *)data;

	ui_viewmgr_view_pop(ad->viewmgr);
}

static void view2_next_btn_clicked_cb(void *data, Evas_Object *obj, void *event_info)
{
	appdata_s *ad = (appdata_s *)data;
...
Eina_Bool _view2_load_cb(void *data, ui_view *view, void *event_info)
{
	appdata_s *ad = (appdata_s *)data;

	Evas_Object *base_layout = ui_view_base_layout_get(ad->view2);

	Evas_Object *content = create_content(base_layout, "ViewMgr Demo<br>Page 2",
			                              view2_prev_btn_clicked_cb, view2_next_btn_clicked_cb, ad);

	//Title left button
	Evas_Object *left_title_btn = elm_button_add(base_layout);
	elm_object_text_set(left_title_btn, "Cancel");

	//Title right button
	Evas_Object *right_title_btn = elm_button_add(base_layout);
	elm_object_text_set(right_title_btn, "Done");

	ui_view_content_set(ad->view2, content, "Title Buttons", NULL, left_title_btn, right_title_btn);

	return true;
}

static void create_page2(appdata_s *ad)
{
	ad->view2 = ui_view_add(NULL, "page 2");

	ui_view_event_callback_add(ad->view2, "load", _view2_load_cb, ad);

	ui_viewmgr_view_push(ad->viewmgr, ad->view2);

}

static void view1_prev_btn_clicked_cb(void *data, Evas_Object *obj, void *event_info)
{
	appdata_s *ad = (appdata_s *)data;
...
static void view1_next_btn_clicked_cb(void *data, Evas_Object *obj, void *event_info)
{
	appdata_s *ad = (appdata_s *)data;
...
Eina_Bool _view1_load_cb(void *data, ui_view *view, void *event_info)
{
	appdata_s *ad = (appdata_s *)data;
	...
	Evas_Object *content = create_content(base_layout, "ViewMgr Demo<br>Page 1",
			                              view1_prev_btn_clicked_cb, view1_next_btn_clicked_cb, ad);
...
static void create_page1(appdata_s *ad)
{
	ad->view1 = ui_view_add(NULL, "page 1");
...
static void create_base_gui(appdata_s *ad)
{
	...
	ad->viewmgr = ui_viewmgr_add(PACKAGE);

	create_page1(ad);

	ui_viewmgr_activate(ad->viewmgr);
}
